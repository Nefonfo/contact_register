...
<body class="bg-gray-100">
                ...
                <?php
                    ...
                    while ($registro = mysqli_fetch_row($res) ) {
                        echo "<div class='swiper-slide z-0 w-full flex flex-wrap justify-center items-center'>
                                <form class='w-4/5 md:w-2/5 p-6 md:py-12 md:px-5 bg-white shadow-lg rounded-lg' data-register-id='$registro[0]' method='POST'>
                                    ...
                                    <div class='w-full mb-4 flex flex-wrap flex-col'>
                                        ...
                                        <input type='hidden' value='$registro[0]' name='id'>
                                    ...
                                    <div class='w-full mt-8 flex flex-wrap justify-center items-center'>
                                        <button data-form-action='delete' type='submit' class='flex flex-wrap justify-center items-center w-full mb-2 md:mb-0 md:w-2/5 mx-1 px-4 py-2 rounded-lg shadow-md hover:shadow-lg bg-red-400 hover:bg-red-600 text-white transition-colors duration-300 ease-in-out' name='delete'>
                                        ...
                                        <button data-form-action='update' type='submit' class='flex flex-wrap justify-center items-center w-full mb-2 md:mb-0 md:w-2/5 mx-1 px-4 py-2 rounded-lg shadow-md hover:shadow-lg bg-green-400 hover:bg-green-600 text-white transition-colors duration-300 ease-in-out' name='update'>
    ...
    <!-- ADD BUTTON ENDS-->
    <form id="modal_add" class="hidden z-50 fixed w-full h-full top-0 left-0 flex items-center justify-center" style="overflow-x: hidden; overflow-y: visible !important;" method="POST">
        ...
        <div class="z-50 w-4/5 md:w-2/5 p-6 md:py-12 md:px-5 bg-white shadow-lg rounded-lg">
            <div class="w-full mb-2 flex flex-wrap justify-center">
                <h1 class="text-2xl font-light text-purple-800">Agregar Contacto</h1>
            </div>
            <div class="w-full mb-4 flex flex-wrap flex-col">
                <label class="mb-1 text-purple-600 text-sm font-base">Nombre</label>
                <input id="add_name" class="flex-1 appearance-none border border-transparent w-full py-1 px-2 bg-white text-gray-700 placeholder-gray-400 shadow-md rounded-lg text-base ring-2 ring-gray-400 focus:outline-none focus:ring-purple-600 focus:border-transparent" type="text" name="addtxtName">
            </div>
            <div class="w-full mb-4 flex flex-wrap flex-col">
                <label class="mb-1 text-purple-600 text-sm font-base">Cumpleaños</label>
                <input id="add_birthday" class="flex-1 appearance-none border border-transparent w-full py-1 px-2 bg-white text-gray-700 placeholder-gray-400 shadow-md rounded-lg text-base ring-2 ring-gray-400 focus:outline-none focus:ring-purple-600 focus:border-transparent" type="text" data-date-component="birthday" data-date-color="purple" data-date-text-color="white" name="addtxtBirthday">
            </div>
            <div class="w-full mb-4 flex flex-wrap flex-col">
                <label class="mb-1 text-purple-600 text-sm font-base">Telefono</label>
                <input id="add_phone" class="flex-1 appearance-none border border-transparent w-full py-1 px-2 bg-white text-gray-700 placeholder-gray-400 shadow-md rounded-lg text-base ring-2 ring-gray-400 focus:outline-none focus:ring-purple-600 focus:border-transparent" type="number" name="addtxtPhone">
            </div>
            <div class="w-full mt-8 flex flex-wrap justify-center items-center">
